...
[] call compile preProcessFile "lega\gangshop\configDes.sqf";
...
player setVariable ["playerSurrender",false,true];
 ...
 player setVariable ["restrainedbyciv",false,true];
  player setVariable ["restrainedbycop",false,true];
   player setVariable ["restrainedbyMedic",false,true];
...
private _vnGetPuid = getPlayerUID player;
[_vnGetPuid,player] remoteExecCall ["Lega_fnc_vnCheckBounty",2];
diag_log format ["Sending %1 -- %2 to server",_vnGetPuid, player];
diag_log "::Life Client:: Eventhandlers completed";
diag_log "::Life Client:: Setting up user actions";
[] call life_fnc_setupActions;

[] execVM 'lega\newsreport\function\newsarticlesinit.sqf';
[] execVM 'lega\PlayerMenu\PlayerMenuVars.sqf';
execVM 'lega\building\BuildConfig.sqf';
