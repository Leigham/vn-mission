...
if (side player isEqualTo civilian || side player isEqualTo Independent) then {
...
if(playerside isEqualto west)then{
	_unit setVariable["restrained",true,true];
	_unit setVariable ["restrainedbycop",true,true];
};
if(playerside isEqualto Independent)then{
	_unit setVariable["restrained",true,true];
	_unit setVariable ["restrainedbyMedic",true,true];
};
