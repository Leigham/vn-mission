...
#define Btn8 37457
#define Title 37401
systemChat "Touch me:: Opening House Menu";
private ["_display","_curTarget","_Btn1","_Btn2","_Btn3","_Btn4","_Btn5","_Btn6","_Btn7","_Btn8"];
disableSerialization;
_curTarget = param [0,objNull,[objNull]];
if (isNull _curTarget) exitWith {systemChat "Bad Target"}; //Bad target
_houseCfg = [(typeOf _curTarget)] call life_fnc_houseConfig;
//systemChat format ["HouseCFG = %1",_houseCfg];
if (count _houseCfg isEqualTo 0 && playerSide isEqualTo civilian) exitWith {};
//systemChat "Touch me :: Finished Loading CFG, and is Applicable.";
if (!dialog) then {
