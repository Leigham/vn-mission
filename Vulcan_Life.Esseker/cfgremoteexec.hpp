...
class CfgRemoteExec {
    class Functions {
		...
		F(life_fnc_removeChair,CLIENT)
		/*BountySystem*/
		F(Lega_fnc_vn_getBounty,SERVER)
        F(Lega_fnc_vnSaveBounty,SERVER)
        F(Lega_fnc_vnCheckBounty,SERVER)
		F(legac_fnc_vnupdateBountyList,CLIENT)
		F(legac_fnc_vnonplayerkilled, CLIENT)
		F(legac_fnc_vnBountyClaimed, CLIENT)
		F(Lega_fnc_deleteBounty,SERVER)
		
		/*Building System */
		F(legac_fnc_StartBuild,CLIENT)
		F(legac_fnc_StartBuildSmall,CLIENT)
		F(legac_fnc_StartBuildLarge,CLIENT)
		F(legac_fnc_StartBuildPlot,CLIENT)
		F(Lega_fnc_SavePlot,SERVER)
		F(Lega_fnc_SaveObject,SERVER)
		F(Lega_fnc_UpdateCustomBuildables,SERVER)
		
		
		/*Random Vehicle Spawns*/
		F(Lega_fnc_ranTankInit,SERVER)
