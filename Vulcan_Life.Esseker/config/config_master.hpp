...
/* System Settings */
    ...
    vehicle_rental_multiplier_CIVILIAN = 0.50; //Civilian Vehicle Rental Price = Config_Vehicle price * multiplier
    vehicle_rental_multiplier_COP = 0.50; //Cop Vehicle Rental Price = Config_Vehicle price * multiplier
    vehicle_rental_multiplier_MEDIC = 0.50; //Medic Vehicle Rental Price = Config_Vehicle price * multiplier
